                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="mt-4 p-4 bg-mist/50 rounded-lg text-sm text-charcoal/80 italic">
                                    ℹ️ Konečná cena se mění v závislosti na konkrétním termínu (sezóna/mimo sezónu) a počtu ubytovaných osob. Pro přesnou kalkulaci nás prosím kontaktujte.
                                </div>
                            </div>
                        </div>
