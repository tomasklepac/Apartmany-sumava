                        ...
                        <div className="bg-cream-dark p-8 rounded-xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a
                                    ...
                                    className="flex items-center justify-center space-x-3 px-6 py-4 bg-forest-dark text-cream rounded-full hover:bg-forest-medium transition-all shadow-md group"
                                >
